...
def setup_model_dataset(args):
    if args.dataset == "custom":
        ...
        # whole_loader =  None
        # train_full_loader = distill_loader(num_workers=2, 
        #                                images_file = '/notebooks/Unlearn-Sparse/distilled_data/CIFAR-10_ipc1/images.pt', 
        #                                labels_file = '/notebooks/Unlearn-Sparse/distilled_data/CIFAR-10_ipc1/labels.pt')
        
        marked_loader_forget = distill_loader(num_workers=2, 
                                              images_file = '/notebooks/Unlearn-Sparse/distilled_data/CIFAR-10_ipc50_zca/images.pt', 
                                              labels_file = '/notebooks/Unlearn-Sparse/distilled_data/CIFAR-10_ipc50_zca/labels.pt')
        
        if args.all_distill:
            marked_loader_retain =  distill_loader(num_workers=2, 
                                              images_file = '/notebooks/Unlearn-Sparse/distilled_data/CIFAR-10_ipc50_zca/images.pt', 
                                              labels_file = '/notebooks/Unlearn-Sparse/distilled_data/CIFAR-10_ipc50_zca/labels.pt')
            
            forget_eval_loader, val_loader, test_loader = cifar10_dataloaders(
            ...
            marked_loader_retain, val_loader, test_loader = cifar10_dataloaders(
                batch_size=args.batch_size,
                data_dir=args.data,
                num_workers=args.workers,
                class_to_replace=args.class_to_replace,
            ...
            forget_eval_loader = marked_loader_retain
        ...
        print(model)
        print('I AM HERE')
        print('LEN OF VAL AND TRAIN LOADERS:', [len(val_loader), len(test_loader)])
        # return model, train_full_loader, val_loader, test_loader, marked_loader_forget, marker_loader_retain
        return model, val_loader, test_loader, marked_loader_forget, marked_loader_retain, forget_eval_loader
